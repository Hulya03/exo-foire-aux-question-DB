...
('2024-12-05', 'Que signifie le sigle noSQL ?','noSQL ?	Not Only SQL !','3')
;

INSERT INTO contenir
(question_id, category_name)
VALUES
('1', 'Bases de données' ), ('1',"SQL"),
('2', 'Bases de données' ), ('2','SQL'),
('3', 'Bases de données' ), 
('4', 'Bases de données' ), ('4','SQL'),
('5', 'Bases de données' ), ('5',"NoSQL")
;